...
- **L** - Quick save
- **ZL** - Quick load
- **R** - Lewy przycisk myszy
- **ZR** - Prawy przycisk myszy
...
1. **1x** - Widok 1:1 (320x240 pikseli gry)
2. **2x** - Widok 160x120 pikseli gry (2x powiększenie)
3. **4x** - Widok 80x60 pikseli gry (4x powiększenie)
4. **8x** - Widok 40x30 pikseli gry (8x powiększenie)
